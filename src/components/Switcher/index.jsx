...
import MicInputContainer from "./../../containers/MicInputContainer.js";
import KeyboardInputContainer from "./../../containers/KeyboardInputContainer.js";
...
class Switcher extends React.Component {
  ...
  render() {
    const component =
      this.state.input === "mic" ? (
        <MicInputContainer speechUtil={this.speechUtil} />
      ) : (
